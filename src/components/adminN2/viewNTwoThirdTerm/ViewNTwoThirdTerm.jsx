...
import { selectNurseryTwoThirdResults, STORE_NURSERYTWOTHIRDRESULT } from '../../../redux/slice/nurseryTwoThirdSlice';




const ViewNTwoThirdTerm = () => {
  
  
  const {data, isLoading} = useFetchCollection("20242025NtwoThirdTerm")
  console.log(data);
...
const confirmDelete = (id) => {
  ...
  Notiflix.Confirm.show(
    ...
    'Cancel',
    function okCb() {
      deleteNurseryTwoThirdTermResult(id);
    },
    function cancelCb() {
...
const deleteNurseryTwoThirdTermResult = async(id) => {
  try {
    await deleteDoc(doc(db, "20242025NtwoThirdTerm", id));
  ...
  return (
    ...
    <div className="table">
    <h2>All Nursery Two Third Term Result</h2>
         ...
         {nTwoResults.map((nTwoResult, index) => {
          ...
          return (
            ...
            <tr key={id}>
               ...
               <td>
                  <Link to={`/add-nurserytwothirdterm/${id}`}>
...
export default ViewNTwoThirdTerm;
