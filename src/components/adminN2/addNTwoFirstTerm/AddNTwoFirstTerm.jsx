...
import { selectNurseryTwoFirstResults } from '../../../redux/slice/nurseryTwoFirstSlice';
...
const AddNTwoFirstTerm = () => {
   ...
   const addnTwoResult = (e)=>{
      ...
      try {
        ...
        const docRef =  addDoc(collection(db, "20242025NtwoFirstTerm"), {
        ...
        navigate('/all-nurserytworesultfirstterm')
   ...
   const editNTwoResult = (e) =>{
      ...
      setIsLoading(true)
        ...
        try {
           ...
           setDoc(doc(db, "20242025NtwoFirstTerm", id), {
            firstName: nTwoResult.firstName,
            lastName: nTwoResult.lastName,
            numeracy: nTwoResult.numeracy,
            literacy: nTwoResult.literacy,
  ...
  return (
    ...
    <div className="addtop">
        <h1 className="newStudent">{detectForm(id, "Add Nursery Two First Term Result", "Edit Result")}</h1>
    </div>
...
export default AddNTwoFirstTerm;
