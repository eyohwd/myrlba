...
import { selectNurseryTwoSecondResults } from '../../../redux/slice/nurseryTwoSecondSlice';
...
const AddNTwoSecondTerm = () => {
   ...
   const addnTwoResult = (e)=>{
      ...
      try {
        ...
        const docRef =  addDoc(collection(db, "20242025NtwoSecondTerm"), {
        ...
        navigate('/all-nurserytworesultsecondterm')
   ...
   const editNTwoResult = (e) =>{
      ...
      setIsLoading(true)
        ...
        try {
           ...
           setDoc(doc(db, "20242025NtwoSecondTerm", id), {
            firstName: nTwoResult.firstName,
            lastName: nTwoResult.lastName,
            numeracy: nTwoResult.numeracy,
            literacy: nTwoResult.literacy,
  ...
  return (
    ...
    <div className="addtop">
        <h1 className="newStudent">{detectForm(id, "Add Nursery Two Second Term Result", "Edit Result")}</h1>
    </div>
...
export default AddNTwoSecondTerm;
