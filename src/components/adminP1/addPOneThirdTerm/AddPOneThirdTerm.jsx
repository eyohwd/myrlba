...
import { selectPrimaryOneThirdResults } from '../../../redux/slice/primaryOneThirdSlice';
...
const AddPOneThirdTerm = () => {
   ...
   const addpOneResult = (e)=>{
      ...
      try {
        ...
        const docRef =  addDoc(collection(db, "20242025PoneThirdTerm"), {
        ...
        navigate('/all-primaryoneresultthirdterm')
   ...
   const editPOneResult = (e) =>{
      ...
      setIsLoading(true)
        ...
        try {
           ...
           setDoc(doc(db, "20242025PoneThirdTerm", id), {
            firstName: pOneResult.firstName,
            lastName: pOneResult.lastName,
            numeracy: pOneResult.numeracy,
            literacy: pOneResult.literacy,
  ...
  return (
    ...
    <div className="addtop">
        <h1 className="newStudent">{detectForm(id, "Add Primary One Third Term Result", "Edit Result")}</h1>
    </div>
...
export default AddPOneThirdTerm;
