...
import { selectPrimaryOneSecondResults } from '../../../redux/slice/primaryOneSecondSlice';
...
const AddPOneSecondTerm = () => {
   ...
   const addpOneResult = (e)=>{
      ...
      try {
        ...
        const docRef =  addDoc(collection(db, "20242025PoneSecondTerm"), {
        ...
        navigate('/all-primaryoneresultsecondterm')
   ...
   const editPOneResult = (e) =>{
      ...
      setIsLoading(true)
        ...
        try {
           ...
           setDoc(doc(db, "20242025PoneSecondTerm", id), {
            firstName: pOneResult.firstName,
            lastName: pOneResult.lastName,
            numeracy: pOneResult.numeracy,
            literacy: pOneResult.literacy,
  ...
  return (
    ...
    <div className="addtop">
        <h1 className="newStudent">{detectForm(id, "Add Primary One Second Term Result", "Edit Result")}</h1>
    </div>
...
export default AddPOneSecondTerm;
