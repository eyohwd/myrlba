...
import { selectPrimaryTwoThirdResults } from '../../../redux/slice/primaryTwoThirdSlice';
...
const AddPTwoThirdTerm = () => {
   ...
   const addpTwoResult = (e)=>{
      ...
      try {
        ...
        const docRef =  addDoc(collection(db, "20242025PtwoThirdTerm"), {
        ...
        navigate('/all-primarytworesultthirdterm')
   ...
   const editPTwoResult = (e) =>{
      ...
      setIsLoading(true)
        ...
        try {
           ...
           setDoc(doc(db, "20242025PtwoThirdTerm", id), {
            firstName: pTwoResult.firstName,
            lastName: pTwoResult.lastName,
            numeracy: pTwoResult.numeracy,
            literacy: pTwoResult.literacy,
  ...
  return (
    ...
    <div className="addtop">
        <h1 className="newStudent">{detectForm(id, "Add Primary Two Third Term Result", "Edit Result")}</h1>
    </div>
...
export default AddPTwoThirdTerm;
