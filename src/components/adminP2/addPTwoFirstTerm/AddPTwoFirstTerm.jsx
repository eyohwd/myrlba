...
import { selectPrimaryTwoFirstResults } from '../../../redux/slice/primaryTwoFirstSlice';
...
const AddPTwoFirstTerm = () => {
   ...
   const addpTwoResult = (e)=>{
      ...
      try {
        ...
        const docRef =  addDoc(collection(db, "20242025PtwoFirstTerm"), {
        ...
        navigate('/all-primarytworesultfirstterm')
   ...
   const editPTwoResult = (e) =>{
      ...
      setIsLoading(true)
        ...
        try {
           ...
           setDoc(doc(db, "20242025PtwoFirstTerm", id), {
            firstName: pTwoResult.firstName,
            lastName: pTwoResult.lastName,
            numeracy: pTwoResult.numeracy,
            literacy: pTwoResult.literacy,
  ...
  return (
    ...
    <div className="addtop">
        <h1 className="newStudent">{detectForm(id, "Add Primary Two First Term Result", "Edit Result")}</h1>
    </div>
...
export default AddPTwoFirstTerm;
