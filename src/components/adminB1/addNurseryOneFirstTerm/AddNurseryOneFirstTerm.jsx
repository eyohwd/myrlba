...
import './addNurseryOneFirstTerm.css';
...
import { selectNurseryOneFirstResults } from '../../../redux/slice/nurseryOneFirstSlice';
...
const AddNurseryOneFirstTerm = () => {
   ...
   const addnOneResult = (e)=>{
      ...
      try {
        ...
        const docRef =  addDoc(collection(db, "20242025NoneFirstTerm"), {
        ...
        navigate('/all-nurseryoneresultfirstterm')
   ...
   const editNOneResult = (e) =>{
      ...
      setIsLoading(true)
        ...
        try {
           ...
           setDoc(doc(db, "20242025NoneFirstTerm", id), {
            firstName: nOneResult.firstName,
            lastName: nOneResult.lastName,
            numeracy: nOneResult.numeracy,
            literacy: nOneResult.literacy,
  ...
  return (
    ...
    <div className="addtop">
        <h1 className="newStudent">{detectForm(id, "Add First Term Result", "Edit Result")}</h1>
    </div>
...
export default AddNurseryOneFirstTerm;
