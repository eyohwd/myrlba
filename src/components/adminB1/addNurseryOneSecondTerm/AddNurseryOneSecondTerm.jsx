...
import './addNurseryOneSecondTerm.css';
...
import { selectNurseryOneSecondResults } from '../../../redux/slice/nurseryOneSecondSlice';
...
const AddNurseryOneSecondTerm = () => {
   ...
   const addnOneResult = (e)=>{
      ...
      try {
        ...
        const docRef =  addDoc(collection(db, "20242025NoneSecondTerm"), {
        ...
        navigate('/all-nurseryoneresultsecondterm')
   ...
   const editNOneResult = (e) =>{
      ...
      setIsLoading(true)
        ...
        try {
           ...
           setDoc(doc(db, "20242025NoneSecondTerm", id), {
            firstName: nOneResult.firstName,
            lastName: nOneResult.lastName,
            numeracy: nOneResult.numeracy,
            literacy: nOneResult.literacy,
  ...
  return (
    ...
    <div className="addtop">
        <h1 className="newStudent">{detectForm(id, "Add Second Term Result", "Edit Result")}</h1>
    </div>
...
export default AddNurseryOneSecondTerm;
